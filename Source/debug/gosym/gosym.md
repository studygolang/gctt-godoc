...
### Package files
 [pclntab.go](//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/pclntab.go) [symtab.go](//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go)

<h2 id="DecodingError">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L697">DecodingError</a>
...
<h3 id="DecodingError.Error">func (*DecodingError) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L703">Error</a>
    <a href="#DecodingError.Error">¶</a></h3>
<pre>func (e *<a href="#DecodingError">DecodingError</a>) Error() <a href="/builtin/#string">string</a></pre>


<h2 id="Func">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L68">Func</a>
    <a href="#Func">¶</a></h2>
...
<h2 id="LineTable">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/pclntab.go#L19">LineTable</a>
...
<h3 id="NewLineTable">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/pclntab.go#L112">NewLineTable</a>
...
<h3 id="LineTable.LineToPC">func (*LineTable) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/pclntab.go#L96">LineToPC</a>
...
<h3 id="LineTable.PCToLine">func (*LineTable) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/pclntab.go#L85">PCToLine</a>
...
<h2 id="Obj">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L90">Obj</a>
    <a href="#Obj">¶</a></h2>
<pre>type Obj struct {
...
<h2 id="Sym">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L18">Sym</a>
    <a href="#Sym">¶</a></h2>
<pre>type Sym struct {
...
<h3 id="Sym.BaseName">func (*Sym) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L60">BaseName</a>
    <a href="#Sym.BaseName">¶</a></h3>
<pre>func (s *<a href="#Sym">Sym</a>) BaseName() <a href="/builtin/#string">string</a></pre>

BaseName returns the symbol name without the package or receiver name.

<h3 id="Sym.PackageName">func (*Sym) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L32">PackageName</a>
...
<h3 id="Sym.ReceiverName">func (*Sym) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L46">ReceiverName</a>
...
<h3 id="Sym.Static">func (*Sym) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L28">Static</a>
    <a href="#Sym.Static">¶</a></h3>
<pre>func (s *<a href="#Sym">Sym</a>) Static() <a href="/builtin/#bool">bool</a></pre>

Static reports whether this symbol is static (not visible outside its file).

<h2 id="Table">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L108">Table</a>
    <a href="#Table">¶</a></h2>
...
<h3 id="NewTable">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L273">NewTable</a>
...
<h3 id="Table.LineToPC">func (*Table) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L508">LineToPC</a>
...
<h3 id="Table.LookupFunc">func (*Table) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L554">LookupFunc</a>
...
<h3 id="Table.LookupSym">func (*Table) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L538">LookupSym</a>
...
<h3 id="Table.PCToFunc">func (*Table) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L473">PCToFunc</a>
...
<h3 id="Table.PCToLine">func (*Table) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L492">PCToLine</a>
...
<h3 id="Table.SymByAddr">func (*Table) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L565">SymByAddr</a>
...
<h2 id="UnknownFileError">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L679">UnknownFileError</a>
...
<h3 id="UnknownFileError.Error">func (UnknownFileError) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L681">Error</a>
...
<h2 id="UnknownLineError">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L686">UnknownLineError</a>
...
<h3 id="UnknownLineError.Error">func (*UnknownLineError) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/debug/gosym/symtab.go#L691">Error</a>
