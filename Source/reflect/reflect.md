...
<h2 id="StringHeader">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/reflect/value.go#L1773">StringHeader</a>
...
- [☞](//github.com/golang/go/blob/release-branch.go1.10/src/reflect/type.go#L200)  FieldByName and related functions consider struct field names to be equal if
