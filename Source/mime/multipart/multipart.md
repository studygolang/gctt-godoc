...
### Package files
 [formdata.go](//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/formdata.go) [multipart.go](//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/multipart.go) [writer.go](//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/writer.go)
...
<h2 id="File">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/formdata.go#L151">File</a>
    <a href="#File">¶</a></h2>
...
<h2 id="FileHeader">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/formdata.go#L130">FileHeader</a>
...
<h3 id="FileHeader.Open">func (*FileHeader) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/formdata.go#L140">Open</a>
...
<h2 id="Form">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/formdata.go#L108">Form</a>
    <a href="#Form">¶</a></h2>
...
<h3 id="Form.RemoveAll">func (*Form) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/formdata.go#L114">RemoveAll</a>
    <a href="#Form.RemoveAll">¶</a></h3>
<pre>func (f *<a href="#Form">Form</a>) RemoveAll() <a href="/builtin/#error">error</a></pre>

RemoveAll removes any temporary files associated with a Form.

<h2 id="Part">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/multipart.go#L24">Part</a>
    <a href="#Part">¶</a></h2>
...
<h3 id="Part.Close">func (*Part) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/multipart.go#L270">Close</a>
    <a href="#Part.Close">¶</a></h3>
<pre>func (p *<a href="#Part">Part</a>) Close() <a href="/builtin/#error">error</a></pre>


<h3 id="Part.FileName">func (*Part) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/multipart.go#L67">FileName</a>
...
<h3 id="Part.FormName">func (*Part) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/multipart.go#L53">FormName</a>
...
<h3 id="Part.Read">func (*Part) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/multipart.go#L146">Read</a>
...
<h2 id="Reader">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/multipart.go#L278">Reader</a>
    <a href="#Reader">¶</a></h2>
...
<h3 id="NewReader">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/multipart.go#L89">NewReader</a>
...
<h3 id="Reader.NextPart">func (*Reader) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/multipart.go#L292">NextPart</a>
...
<h3 id="Reader.ReadForm">func (*Reader) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/formdata.go#L20">ReadForm</a>
...
<h2 id="Writer">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/writer.go#L9">Writer</a>
    <a href="#Writer">¶</a></h2>
...
<h3 id="NewWriter">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/writer.go#L17">NewWriter</a>
...
<h3 id="Writer.Boundary">func (*Writer) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/writer.go#L25">Boundary</a>
    <a href="#Writer.Boundary">¶</a></h3>
<pre>func (w *<a href="#Writer">Writer</a>) Boundary() <a href="/builtin/#string">string</a></pre>

Boundary returns the Writer's boundary.

<h3 id="Writer.Close">func (*Writer) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/writer.go#L154">Close</a>
...
<h3 id="Writer.CreateFormField">func (*Writer) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/writer.go#L135">CreateFormField</a>
...
<h3 id="Writer.CreateFormFile">func (*Writer) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/writer.go#L124">CreateFormFile</a>
...
<h3 id="Writer.CreatePart">func (*Writer) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/writer.go#L81">CreatePart</a>
...
<h3 id="Writer.FormDataContentType">func (*Writer) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/writer.go#L64">FormDataContentType</a>
...
<h3 id="Writer.SetBoundary">func (*Writer) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/writer.go#L35">SetBoundary</a>
...
<h3 id="Writer.WriteField">func (*Writer) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/mime/multipart/writer.go#L143">WriteField</a>
