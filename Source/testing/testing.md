...
### Package files
 [allocs.go](//github.com/golang/go/blob/release-branch.go1.10/src/testing/allocs.go) [benchmark.go](//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go) [cover.go](//github.com/golang/go/blob/release-branch.go1.10/src/testing/cover.go) [example.go](//github.com/golang/go/blob/release-branch.go1.10/src/testing/example.go) [match.go](//github.com/golang/go/blob/release-branch.go1.10/src/testing/match.go) [testing.go](//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go)

<h2 id="AllocsPerRun">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/allocs.go#L10">AllocsPerRun</a>
...
<h2 id="CoverMode">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L307">CoverMode</a>
...
<h2 id="Coverage">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/cover.go#L35">Coverage</a>
...
<h2 id="Main">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L894">Main</a>
    <a href="#Main">¶</a></h2>
...
<h2 id="RegisterCover">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/cover.go#L54">RegisterCover</a>
...
<h2 id="RunBenchmarks">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L367">RunBenchmarks</a>
...
<h2 id="RunExamples">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/example.go#L16">RunExamples</a>
...
<h2 id="RunTests">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L1025">RunTests</a>
...
<h2 id="Short">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L300">Short</a>
    <a href="#Short">¶</a></h2>
<pre>func Short() <a href="/builtin/#bool">bool</a></pre>

Short reports whether the -test.short flag is set.

<h2 id="Verbose">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L312">Verbose</a>
    <a href="#Verbose">¶</a></h2>
<pre>func Verbose() <a href="/builtin/#bool">bool</a></pre>

Verbose reports whether the -test.v flag is set.

<h2 id="B">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L38">B</a>
    <a href="#B">¶</a></h2>
<pre>type B struct {
...
<h3 id="B.Error">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L567">Error</a>
    <a href="#B.Error">¶</a></h3>
<pre>func (c *<a href="#B">B</a>) Error(args ...interface{})</pre>

Error is equivalent to Log followed by Fail.

<h3 id="B.Errorf">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L573">Errorf</a>
    <a href="#B.Errorf">¶</a></h3>
<pre>func (c *<a href="#B">B</a>) Errorf(format <a href="/builtin/#string">string</a>, args ...interface{})</pre>

Errorf is equivalent to Logf followed by Fail.

<h3 id="B.Fail">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L491">Fail</a>
    <a href="#B.Fail">¶</a></h3>
<pre>func (c *<a href="#B">B</a>) Fail()</pre>

Fail marks the function as having failed but continues execution.

<h3 id="B.FailNow">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L520">FailNow</a>
...
<h3 id="B.Failed">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L505">Failed</a>
    <a href="#B.Failed">¶</a></h3>
<pre>func (c *<a href="#B">B</a>) Failed() <a href="/builtin/#bool">bool</a></pre>

Failed reports whether the function has failed.

<h3 id="B.Fatal">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L579">Fatal</a>
    <a href="#B.Fatal">¶</a></h3>
<pre>func (c *<a href="#B">B</a>) Fatal(args ...interface{})</pre>

Fatal is equivalent to Log followed by FailNow.

<h3 id="B.Fatalf">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L585">Fatalf</a>
    <a href="#B.Fatalf">¶</a></h3>
<pre>func (c *<a href="#B">B</a>) Fatalf(format <a href="/builtin/#string">string</a>, args ...interface{})</pre>

Fatalf is equivalent to Logf followed by FailNow.

<h3 id="B.Helper">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L634">Helper</a>
...
<h3 id="B.Log">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L557">Log</a>
    <a href="#B.Log">¶</a></h3>
...
<h3 id="B.Logf">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L564">Logf</a>
    <a href="#B.Logf">¶</a></h3>
...
<h3 id="B.Name">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L477">Name</a>
    <a href="#B.Name">¶</a></h3>
<pre>func (c *<a href="#B">B</a>) Name() <a href="/builtin/#string">string</a></pre>

Name returns the name of the running test or benchmark.

<h3 id="B.ReportAllocs">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L108">ReportAllocs</a>
...
<h3 id="B.ResetTimer">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L89">ResetTimer</a>
...
<h3 id="B.Run">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L468">Run</a>
    <a href="#B.Run">¶</a></h3>
...
<h3 id="B.RunParallel">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L581">RunParallel</a>
...
<h3 id="B.SetBytes">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L103">SetBytes</a>
...
<h3 id="B.SetParallelism">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L625">SetParallelism</a>
...
<h3 id="B.Skip">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L591">Skip</a>
    <a href="#B.Skip">¶</a></h3>
<pre>func (c *<a href="#B">B</a>) Skip(args ...interface{})</pre>

Skip is equivalent to Log followed by SkipNow.

<h3 id="B.SkipNow">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L610">SkipNow</a>
...
<h3 id="B.Skipf">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L597">Skipf</a>
    <a href="#B.Skipf">¶</a></h3>
<pre>func (c *<a href="#B">B</a>) Skipf(format <a href="/builtin/#string">string</a>, args ...interface{})</pre>

Skipf is equivalent to Logf followed by SkipNow.

<h3 id="B.Skipped">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L623">Skipped</a>
    <a href="#B.Skipped">¶</a></h3>
<pre>func (c *<a href="#B">B</a>) Skipped() <a href="/builtin/#bool">bool</a></pre>

Skipped reports whether the test was skipped.

<h3 id="B.StartTimer">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L64">StartTimer</a>
...
<h3 id="B.StopTimer">func (*B) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L77">StopTimer</a>
...
<h2 id="BenchmarkResult">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L286">BenchmarkResult</a>
...
<h3 id="Benchmark">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L636">Benchmark</a>
...
<h3 id="BenchmarkResult.AllocedBytesPerOp">func (BenchmarkResult) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L317">AllocedBytesPerOp</a>
...
<h3 id="BenchmarkResult.AllocsPerOp">func (BenchmarkResult) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L309">AllocsPerOp</a>
...
<h3 id="BenchmarkResult.MemString">func (BenchmarkResult) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L345">MemString</a>
...
<h3 id="BenchmarkResult.NsPerOp">func (BenchmarkResult) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L294">NsPerOp</a>
...
<h3 id="BenchmarkResult.String">func (BenchmarkResult) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L324">String</a>
...
<h2 id="Cover">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/cover.go#L21">Cover</a>
    <a href="#Cover">¶</a></h2>
...
<h2 id="CoverBlock">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/cover.go#L8">CoverBlock</a>
...
<h2 id="InternalBenchmark">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L20">InternalBenchmark</a>
...
<h2 id="InternalExample">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/example.go#L7">InternalExample</a>
...
<h2 id="InternalTest">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L706">InternalTest</a>
...
<h2 id="M">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L899">M</a>
    <a href="#M">¶</a></h2>
<pre>type M struct {
    <span class="comment">// contains filtered or unexported fields</span>
}</pre>
...
<h3 id="MainStart">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L929">MainStart</a>
...
<h3 id="M.Run">func (*M) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L939">Run</a>
    <a href="#M.Run">¶</a></h3>
<pre>func (m *<a href="#M">M</a>) Run() <a href="/builtin/#int">int</a></pre>

Run runs the tests. It returns an exit code to pass to os.Exit.

<h2 id="PB">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L548">PB</a>
    <a href="#PB">¶</a></h2>
<pre>type PB struct {
    <span class="comment">// contains filtered or unexported fields</span>
}</pre>
...
<h3 id="PB.Next">func (*PB) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/benchmark.go#L556">Next</a>
    <a href="#PB.Next">¶</a></h3>
<pre>func (pb *<a href="#PB">PB</a>) Next() <a href="/builtin/#bool">bool</a></pre>

Next reports whether there are more iterations to execute.

<h2 id="T">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L468">T</a>
    <a href="#T">¶</a></h2>
<pre>type T struct {
    <span class="comment">// contains filtered or unexported fields</span>
}</pre>
...
<h3 id="T.Error">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L567">Error</a>
    <a href="#T.Error">¶</a></h3>
<pre>func (c *<a href="#T">T</a>) Error(args ...interface{})</pre>

Error is equivalent to Log followed by Fail.

<h3 id="T.Errorf">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L573">Errorf</a>
    <a href="#T.Errorf">¶</a></h3>
<pre>func (c *<a href="#T">T</a>) Errorf(format <a href="/builtin/#string">string</a>, args ...interface{})</pre>

Errorf is equivalent to Logf followed by Fail.

<h3 id="T.Fail">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L491">Fail</a>
    <a href="#T.Fail">¶</a></h3>
<pre>func (c *<a href="#T">T</a>) Fail()</pre>

Fail marks the function as having failed but continues execution.

<h3 id="T.FailNow">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L520">FailNow</a>
...
<h3 id="T.Failed">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L505">Failed</a>
    <a href="#T.Failed">¶</a></h3>
<pre>func (c *<a href="#T">T</a>) Failed() <a href="/builtin/#bool">bool</a></pre>

Failed reports whether the function has failed.

<h3 id="T.Fatal">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L579">Fatal</a>
    <a href="#T.Fatal">¶</a></h3>
<pre>func (c *<a href="#T">T</a>) Fatal(args ...interface{})</pre>

Fatal is equivalent to Log followed by FailNow.

<h3 id="T.Fatalf">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L585">Fatalf</a>
    <a href="#T.Fatalf">¶</a></h3>
<pre>func (c *<a href="#T">T</a>) Fatalf(format <a href="/builtin/#string">string</a>, args ...interface{})</pre>

Fatalf is equivalent to Logf followed by FailNow.

<h3 id="T.Helper">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L634">Helper</a>
...
<h3 id="T.Log">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L557">Log</a>
    <a href="#T.Log">¶</a></h3>
...
<h3 id="T.Logf">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L564">Logf</a>
    <a href="#T.Logf">¶</a></h3>
...
<h3 id="T.Name">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L477">Name</a>
    <a href="#T.Name">¶</a></h3>
<pre>func (c *<a href="#T">T</a>) Name() <a href="/builtin/#string">string</a></pre>

Name returns the name of the running test or benchmark.

<h3 id="T.Parallel">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L661">Parallel</a>
...
<h3 id="T.Run">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L781">Run</a>
    <a href="#T.Run">¶</a></h3>
...
<h3 id="T.Skip">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L591">Skip</a>
    <a href="#T.Skip">¶</a></h3>
<pre>func (c *<a href="#T">T</a>) Skip(args ...interface{})</pre>

Skip is equivalent to Log followed by SkipNow.

<h3 id="T.SkipNow">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L610">SkipNow</a>
...
<h3 id="T.Skipf">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L597">Skipf</a>
    <a href="#T.Skipf">¶</a></h3>
<pre>func (c *<a href="#T">T</a>) Skipf(format <a href="/builtin/#string">string</a>, args ...interface{})</pre>

Skipf is equivalent to Logf followed by SkipNow.

<h3 id="T.Skipped">func (*T) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L623">Skipped</a>
    <a href="#T.Skipped">¶</a></h3>
<pre>func (c *<a href="#T">T</a>) Skipped() <a href="/builtin/#bool">bool</a></pre>

Skipped reports whether the test was skipped.

<h2 id="TB">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/testing/testing.go#L432">TB</a>
    <a href="#TB">¶</a></h2>
