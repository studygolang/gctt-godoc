...
### Package files
 [base64.go](//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go)
...
<h2 id="NewDecoder">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L593">NewDecoder</a>
...
<h2 id="NewEncoder">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L240">NewEncoder</a>
...
<h2 id="CorruptInputError">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L257">CorruptInputError</a>
    <a href="#CorruptInputError">¶</a></h2>
<pre>type CorruptInputError <a href="/builtin/#int64">int64</a></pre>


<h3 id="CorruptInputError.Error">func (CorruptInputError) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L259">Error</a>
...
<h2 id="Encoding">type <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L13">Encoding</a>
...
<h3 id="NewEncoding">func <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L33">NewEncoding</a>
...
<h3 id="Encoding.Decode">func (*Encoding) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L452">Decode</a>
...
<h3 id="Encoding.DecodeString">func (*Encoding) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L364">DecodeString</a>
...
<h3 id="Encoding.DecodedLen">func (*Encoding) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L599">DecodedLen</a>
...
<h3 id="Encoding.Encode">func (*Encoding) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L112">Encode</a>
...
<h3 id="Encoding.EncodeToString">func (*Encoding) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L160">EncodeToString</a>
...
<h3 id="Encoding.EncodedLen">func (*Encoding) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L246">EncodedLen</a>
...
<h3 id="Encoding.Strict">func (Encoding) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L79">Strict</a>
...
<h3 id="Encoding.WithPadding">func (Encoding) <a href="//github.com/golang/go/blob/release-branch.go1.10/src/encoding/base64/base64.go#L61">WithPadding</a>
